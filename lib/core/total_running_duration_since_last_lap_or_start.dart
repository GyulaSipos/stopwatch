...
Duration totalRunningDurationSinceLastLapOrStart(List<StopWatchEvent> events, {bool isCurrentlyRunning = false}) {
  ...
  for (final event in [
    ...
    if (isCurrentlyRunning) End(DateTime.now().millisecondsSinceEpoch),
  ]) {
